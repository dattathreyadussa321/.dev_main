  ...
  return (
    ...
    >
      <nav
        ...
        className="relative mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-5 sm:px-8 lg:h-[72px] lg:px-12"
      >
        {/* Left: logo */}
        <Logo />

        {/* Center: desktop nav — shown at lg+ so it never fights the CTA button */}
